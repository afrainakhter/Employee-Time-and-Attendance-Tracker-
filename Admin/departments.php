    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-sm-6 col-6">
                <input type="text" id="searchInput" onkeyup="searchDepartments()" placeholder="Search for departments.." class="form-control mb-3">
            </div>
        </div>
        <div class="table-responsive">
            <table class="datatable table table-stripped" id="departmentTable">
                <thead>
                    <tr>
                        <th>Department Id</th>
